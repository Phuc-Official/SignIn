...
class _RegisterPasswordPageState extends State<RegisterPasswordPage> {
  ...
  void _register() async {
    ...
    if (password != confirmPassword) {
      showAlertDialog(context, 'Registration Error', 'Password and Confirm Password do not match.');
      return;
    }
    ...
    try {
      ...
      if (user != null) {
        ...
        showAlertDialog(context, '', 'Your account has been created successfully.');
      } else {
        // Nếu đăng ký không thành công, hiển thị thông báo lỗi
        showAlertDialog(context, '', 'There was an error creating your account. Please try again.');
      }
    } catch (e) {
      // Xử lý các lỗi khác có thể xảy ra trong quá trình đăng ký
      showAlertDialog(context, '', 'This email has been registered. Please try again later.');
    }
  }
